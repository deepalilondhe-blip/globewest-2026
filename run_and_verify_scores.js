...
console.log('\n======================================================');
console.log('   RUNNING ALL LIGHTHOUSE AUDITS & RETRIEVING SCORES  ');
console.log('   (This process will take around 3-4 minutes...)     ');
console.log('======================================================\n');

try {
  console.log('Running tests...');
  execSync('npx playwright test tests/lighthouse.spec.js --project=desktop-chrome', { stdio: 'inherit' });
} catch (e) {
  console.log('\n[Info] Scans completed. Retrieving scores...');
}
...
console.log('\n======================================================');
console.log('      LATEST RUN ACCESSIBILITY SCORES VERIFICATION     ');
console.log('======================================================\n');
