#!/usr/bin/env python3
"""
Generate comprehensive Test Cases Excel and CSV for Ticket #41794529: My Account - Quotes.
"""
...
OUT_DIR = '/home/deepali/My Projects/Deepali/GlobeWest 2026 (2)/Sprint-3/Ticket_41794529_My_Account_Quotes'
...
test_cases = [
    {
        ...
        "Expected Result (Figma Spec / Frame 622)": "Active tab must default to 'ALL' with solid charcoal/black background (#1E1E1E) and white text.",
        "Actual Result (mcstaging2 Live)": "Page erroneously defaults to the 'OPEN' tab with plain underlined text. 'ALL' tab is unselected.",
...
# Write CSV
csv_path = os.path.join(OUT_DIR, 'My_Quotes_Test_Cases.csv')
...
# Write XLSX
xlsx_path = os.path.join(OUT_DIR, 'My_Quotes_Test_Cases.xlsx')
df = pd.DataFrame(test_cases)
with pd.ExcelWriter(xlsx_path, engine='openpyxl') as writer:
    df.to_excel(writer, sheet_name='My Quotes Test Cases', index=False)
